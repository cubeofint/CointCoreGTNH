...
public class CleanupTask extends Task {
    ...
    public List<NotifyTask> getNotifications() {
        ...
        notifications.add(
            new NotifyTask(
                nextTime - Ticks.SECOND.x(30)
                    .millis(),
                CLEANUP.createNotification(getNotificationString(30))));
        notifications.add(
            new NotifyTask(
                nextTime - Ticks.SECOND.x(60)
                    .millis(),
    ...
    private IChatComponent getNotificationString(int seconds) {
        ...
        return StringUtils
            .color(new ChatComponentText(EnumChatFormatting.ITALIC + finalString), EnumChatFormatting.LIGHT_PURPLE);
    }
    ...
    private static boolean shouldDespawn(Entity entity) {
        ...
        if (entity instanceof EntityItem item) {
            return config.items && ItemUtil.removeDropTag(item.getEntityItem());
        }
