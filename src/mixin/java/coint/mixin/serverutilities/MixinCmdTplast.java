 ...
 * <ul>
 * <li>{@code commands.tpl} (existing SU node) — teleport <b>yourself</b> to a player or coords</li>
 ...
 *             See {@link MixinCmdFly} for the full explanation of why the
 *             {@code remap = false} + {@code processCommand} approach silently fails at
 *             runtime. This class is kept for historical reference only and is
 *             <em>not</em> listed in {@code mixins.cointcore.json}.
 */
@Deprecated
